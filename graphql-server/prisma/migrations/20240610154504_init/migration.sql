/*
  ...
  - You are about to drop the column `id` on the `RawDisclosureData` table. All the data in the column will be lost.

*/
-- AlterTable
ALTER TABLE "RawDisclosureData" DROP CONSTRAINT "RawDisclosureData_pkey",
DROP COLUMN "id",
ADD CONSTRAINT "RawDisclosureData_pkey" PRIMARY KEY ("caseNumber");
